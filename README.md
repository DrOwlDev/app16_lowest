...
That snapshot includes Polymarket odds **and** preloaded station temperature
series (WRH METAR/NWS/Open-Meteo and Hong Kong HKO hkoc+OCF) so expand charts
work without live weather APIs in the browser.
